...
(function () {
    ...
    describe('Edit Codesystemversions Controller Tests', function () {
        // Initialize global variables
        var EditCodesystemversionsController,
            scope,
            $httpBackend,
            $stateParams,
            $location;
        ...
        beforeEach(inject(function ($controller, $rootScope, _$location_, _$stateParams_, _$httpBackend_) {
            ...
            EditCodesystemversionsController = $controller('EditCodesystemversionsController', {
                $scope: scope
            });
        }));
        ...
        it('$scope.findOne() should create an array with one Codesystemversion object fetched from XHR using a codesystemversionId URL parameter', inject(function (Codesystemversions) {
            ...
            var sampleCodesystemversion = {CodeSystemVersionCatalogEntryMsg: {heading: {resourceRoot: "http://test"}, codeSystemVersionCatalogEntry: {}}};
            ...
            // Test scope value
            expect(scope.codesystemversion).toEqualData({});
        }));
